...
// if ($name and $Categor and $Price and $Discription) {
    $query = "INSERT INTO `Product` (`Name`, `Category_id`, `Description`, `Price`, `Image`) 
    VALUES ('$name', '$Categor ', ' $Discription', '$Price', '$Image')";
    $result = mysqli_query($con, $query);
    "<script>alert('Запись создана!');location.href = 'newTovar.php';
    </script>";
